                        ...
                        <table class="table table-hover">
                            ...
                            if($listData){
                                ...
                                foreach ($listData as $list){
                                    ...
                                    echo '<td><img width="100" height="100" src="'.$list['video_tag'].'"></td>';
                                    echo '<td><label style="color: '.$list['color_tag'].'">'.$list['color_tag'].'</label></td>';
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Color Tag</label>
                        <input type="input" name ="color_tag" value = "<?php echo $update_data!=null?$update_data["color_tag"]:""; ?>" class="form-control" id="exampleInputEmail1" >
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Social Logo</label>
                        <input type="file" name ="logo" class="form-control" id="exampleInputEmail1" >
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Video Tag</label>
                        <input type="file" name ="video_tag" class="form-control" id="exampleInputEmail1" >
                    </div>
