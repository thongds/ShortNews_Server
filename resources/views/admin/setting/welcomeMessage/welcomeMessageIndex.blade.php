                        ...
                        <table class="table table-hover">
                            ...
                            if($listData){
                                ...
                                foreach ($listData as $list){
                                    ...
                                    echo '<td class="col-md-3">'.$list['welcome_msg'].'</td>';
                                    echo '<td class="col-md-3">'.$list['event_msg'].'</td>';
                                   ...
                                   // echo '<td><span class="label '.$labeClass.'">'.$labeName.'</span></td>';
                                    echo '<td><img src ="'.$list["avatar_morning"].'" width = 60 height = 60/></td>';
                                    echo '<td><img src ="'.$list["avatar_night"].'" width = 60 height = 60/></td>';
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="input" name ="welcome_msg" value = "<?php echo $update_data!=null?$update_data["welcome_msg"]:""; ?>" class="form-control" id="exampleInputEmail1" >
                        <div class="form-group">

                         <label for="exampleInputEmail1">Event Message</label>
                         <input type="input" name ="event_msg" value = "<?php echo $update_data!=null?$update_data["event_msg"]:""; ?>" class="form-control" id="exampleInputEmail1" >
                         <div class="form-group">
                         ...
                         <div class="form-group">
                                <label for="exampleInputEmail1">Avatar Morning</label>
                                <input type="file" name ="avatar_morning" class="form-control" id="exampleInputEmail1" >
                         </div>

                         <div class="form-group">
                                <label for="exampleInputEmail1">Avatar Night</label>
                                <input type="file" name ="avatar_night" class="form-control" id="exampleInputEmail1" >
                         </div>
