        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                    <a href="#">
                        <i class="fa fa-dashboard"></i> <span>News Setting</span>
                ...
                <li class="active treeview">
                    <a href="#">
                        <i class="fa fa-dashboard"></i> <span>Social setting</span>
                        <span class="pull-right-container">
                             <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{URL("admin/social-info")}}"><i class="fa fa-circle-o"></i>Social Info </a></li>
                    </ul>
                    <ul class="treeview-menu">
                        <li><a href="{{URL("admin/fanpage")}}"><i class="fa fa-circle-o"></i>Fan Page </a></li>
                    </ul>
                    <ul class="treeview-menu">
                        <li><a href="{{URL("admin/social-content-type")}}"><i class="fa fa-circle-o"></i>Social Content Type </a></li>
                    </ul>
                    <ul class="treeview-menu">
                        <li><a href="{{URL("admin/social-media")}}"><i class="fa fa-circle-o"></i>Social Media </a></li>
                    </ul>
                </li>
                <li class="active treeview">
                    <a href="#">
